...
class IndexWeightDataLoader(AbstractRawDataLoader):
    ...
    def _all_dim_definitions(self):
        return {"WEIGHT":DataType.Float64 } #if not self.dim_to_new_name else {self.dim_to_new_name["WEIGHT"]:DataType.Float64}
    pass
...
if __name__ == "__main__":
    ...
    HS300_path_template = os.path.join(DATA_BASE_DIR,
                                                    "S:/data/cooked/IndexWeight/{}/{}/{}/SA_TRADABLESHARE_HS300.txt")
    ...
    # HS300_weight_data_loader = IndexWeightDataLoader(user_name, project_name, 'HS300', universe, version_number,\
    #                     ["D:\PycharmProjects\\test/data/raw/WIND/IndexWeight/{}/{}/{}/AINDEXHS300CLOSEWEIGHT.txt"], ["WEIGHT"])

    # HS300_dim_data_loader = IndexWeightDimDataLoader(user_name, project_name, 'HS300', universe, version_number, \
